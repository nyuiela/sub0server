...
import { APPLE_ICON, DISCORD_ICON, EMAIL_ICON, EPIC_ICON, FACEBOOK_ICON, FARCASTER_ICON, GITHUB_ICON, GOOGLE_ICON, GUEST_ICON, LINE_ICON, PASSKEY_ICON, PHONE_ICON, STEAM_ICON, TELEGRAM_ICON, TIKTOK_ICON, TWITCH_ICON, WALLET_ICON, X_ICON, } from "../icons/svgs.js";
