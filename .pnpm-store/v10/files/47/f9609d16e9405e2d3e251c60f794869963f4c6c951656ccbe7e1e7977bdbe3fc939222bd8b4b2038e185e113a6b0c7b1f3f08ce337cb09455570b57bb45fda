...
exports.ChainButton = (0, react_1.memo)(function ChainButton(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(provider_js_1.ChainProvider, { chain: chain, children: (0, jsx_runtime_1.jsxs)(exports.NetworkButton, { "data-active": activeChain?.id === chain.id, onClick: props.onClick, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
                        ...
                        position: "relative",
                                ...
                                height: `${index_js_1.iconSize.lg}px`,
                                width: `${index_js_1.iconSize.lg}px`,
                            } }), activeChain?.id === chain.id && ((0, jsx_runtime_1.jsx)(ChainActiveDot_js_1.ChainActiveDot, { className: "tw-chain-active-dot-button-network-selector" }))] }), confirming || switchingFailed ? ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { alignItems: "flex-start", width: "100%" }, children: [(0, jsx_runtime_1.jsx)(name_js_1.ChainName, { loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "20px", width: "150px" }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", center: "y", flex: "row", gap: "xxs", children: [confirming && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "accentText", size: "xs", children: locale.switchingNetwork }), (0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { color: "accentText", size: "xs" })] })), switchingFailed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { animate: "fadein", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "danger", size: "xs", children: locale.networkSelector.failedToSwitch }) }))] })] })) : ((0, jsx_runtime_1.jsx)(name_js_1.ChainName, { className: "tw-chain-icon-none-confirming", loadingComponent: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "20px", width: "150px" }) }))] }) }));
});
/**
 * @internal Exported for tests
 */
...
function useNetworkSwitcherModal() {
    ...
    const openNetworkSwitcher = (0, react_1.useCallback)(async (props) => {
        ...
        setRootEl((0, jsx_runtime_1.jsx)(CustomThemeProvider_js_1.CustomThemeProvider, { theme: props.theme, children: (0, jsx_runtime_1.jsx)(Modal_js_1.Modal, { className: "tw-modal__switch-network", title: "Switch Network", open: true, setOpen: (value) => {
                    if (!value) {
                        closeModal();
                    }
                }, size: "compact", style: {
