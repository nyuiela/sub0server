...
const useSendAndConfirmTransaction_js_1 = require("../../../../hooks/transaction/useSendAndConfirmTransaction.js");
...
async function getPayMetadata(options) {
    ...
    return {
        image: (0, type_guards_js_1.isString)(contractMetadata?.image)
            ? contractMetadata.image
            : undefined,
        name: (0, type_guards_js_1.isString)(contractMetadata?.name) ? contractMetadata.name : undefined,
    };
}
