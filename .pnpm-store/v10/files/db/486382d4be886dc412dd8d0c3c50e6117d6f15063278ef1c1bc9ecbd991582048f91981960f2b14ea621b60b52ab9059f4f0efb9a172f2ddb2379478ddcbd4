...
import { type GetClaimConditionsParams } from "../read/getClaimConditions.js";
 ...
 * ```
 */
export declare function resetClaimEligibility(options: BaseTransactionOptions<WithOverrides<ResetClaimEligibilityParams>> & {
