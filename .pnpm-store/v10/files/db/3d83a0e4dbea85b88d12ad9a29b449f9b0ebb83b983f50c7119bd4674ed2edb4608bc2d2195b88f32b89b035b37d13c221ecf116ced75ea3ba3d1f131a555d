...
exports.isCreateSessionKeySupported = isCreateSessionKeySupported;
const random_js_1 = require("../../../utils/random.js");
const createSessionWithSig_js_1 = require("../__generated__/MinimalAccount/write/createSessionWithSig.js");
 ...
 * @extension ERC7702
 */
function createSessionKey(options) {
    ...
    return (0, createSessionWithSig_js_1.createSessionWithSig)({
        async asyncParams() {
            const req = {
            ...
            const signature = await account.signTypedData({
                ...
                types: {
                    CallSpec: types_js_1.CallSpecRequest,
                    Constraint: types_js_1.ConstraintRequest,
                    SessionSpec: types_js_1.SessionSpecRequest,
                    TransferSpec: types_js_1.TransferSpecRequest,
                    UsageLimit: types_js_1.UsageLimitRequest,
                },
            });
 ...
 * ```
 */
function isCreateSessionKeySupported(availableSelectors) {
    return (0, createSessionWithSig_js_1.isCreateSessionWithSigSupported)(availableSelectors);
}
//# sourceMappingURL=createSessionKey.js.map