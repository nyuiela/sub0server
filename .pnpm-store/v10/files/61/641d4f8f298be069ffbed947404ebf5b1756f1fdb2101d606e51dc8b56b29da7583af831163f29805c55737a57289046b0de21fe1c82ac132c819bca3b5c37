...
import type { BaseAccountSDKWalletConnectionOptions, BaseAccountWalletCreationOptions } from "./base-account/base-account-web.js";
...
export type WalletId = "walletConnect" | "inApp" | "embedded" | "smart" | "adapter" | typeof BASE_ACCOUNT | EcosystemWalletId | WCSupportedWalletIds | InjectedSupportedWalletIds;
