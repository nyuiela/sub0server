...
export const FN_SELECTOR = "0xba61557d";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "wrappedCalls",
 ...
 * ```
 */
export function isExecuteWithSigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeExecuteWithSigParams(options) {
 ...
 * ```
 */
export function encodeExecuteWithSig(options) {
 ...
 * ```
 */
export function executeWithSig(options) {
