                    ...
                    paddingTop: index_js_1.spacing.lg,
                                ...
                                gap: index_js_1.spacing.xs,
                                        ...
                                        padding: index_js_1.spacing.sm,
                                                ...
                                                }, width: index_js_1.iconSize.sm }) }), locale.send] })), !hideReceiveFunds && ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { className: "tw-highlight-button__receive", onClick: () => {
                                        setScreen("receive");
                                    }, style: {
                                        alignItems: "center",
                                        display: "flex",
                                    ...
                                    !chainMetadataQuery.data.testnet && ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { className: "tw-highlight-button__buy", onClick: () => {
                            ...
                            gap: "1px",
                        }, children: [(0, jsx_runtime_1.jsx)(NetworkSwitcherButton, { client: props.client, disableSwitchChain: disableSwitchChain, displayBalanceToken: props.displayBalanceToken, setScreen: () => setScreen("network-switcher"), showBalanceInFiat: props.detailsModal?.showBalanceInFiat }), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { className: "tw-view-transactions-button", onClick: () => {
                                    setScreen("transactions");
                                }, style: {
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { height: index_js_1.iconSize.md, width: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "y", flex: "row", gap: "xs", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }) })] }), (props.assetTabs === undefined || props.assetTabs.length > 0) && ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { className: "tw-view-assets-button", onClick: () => {
                                    setScreen("view-assets");
                                }, style: {
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(CoinsIcon_js_1.CoinsIcon, { size: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.viewFunds.viewAssets })] })), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { className: "tw-manage-wallet-button", onClick: () => {
...
function NetworkSwitcherButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { className: "tw-internal-network-switcher-button tw-switch-network-button", "data-variant": "primary", disabled: disableSwitchChain, onClick: () => {
