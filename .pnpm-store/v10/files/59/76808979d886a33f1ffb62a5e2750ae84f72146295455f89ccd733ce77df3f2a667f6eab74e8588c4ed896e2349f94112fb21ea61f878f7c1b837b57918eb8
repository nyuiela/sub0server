...
export type AuthProvider = "Cognito" | "Guest" | "Backend" | "Google" | "EmailOtp" | "CustomJWT" | "CustomAuthEndpoint" | "Facebook" | "Apple" | "Passkey" | "Discord" | "Coinbase" | "X" | "TikTok" | "Epic" | "Line" | "Twitch" | "Steam" | "GitHub" | "Farcaster" | "Telegram";
