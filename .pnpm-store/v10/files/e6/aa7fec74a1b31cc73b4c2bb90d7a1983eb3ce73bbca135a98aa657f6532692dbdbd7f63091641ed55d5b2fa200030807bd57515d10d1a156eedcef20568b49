...
const BaseURICount = require("../../../erc721/__generated__/IBatchMintMetadata/read/getBaseURICount.js");
const BatchAtIndex = require("../../__generated__/BatchMintMetadata/read/getBatchIdAtIndex.js");
const BatchBaseURI = require("../../__generated__/DropERC1155/write/updateBatchBaseURI.js");
...
async function getUpdateMetadataParams(options) {
    ...
    const currentMetadatas = await Promise.all(range.map((id) => GetNFT.getNFT({ contract, tokenId: id })));
