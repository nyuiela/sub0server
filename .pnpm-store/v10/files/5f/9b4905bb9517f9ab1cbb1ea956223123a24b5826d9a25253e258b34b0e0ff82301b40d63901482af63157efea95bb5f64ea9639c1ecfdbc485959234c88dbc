...
exports.ConnectWalletSocialOptions = exports.defaultAuthOptions = void 0;
...
const storage_js_2 = require("../../ui/ConnectWallet/Modal/storage.js");
const WalletTypeRowButton_js_1 = require("../../ui/ConnectWallet/WalletTypeRowButton.js");
const badge_js_1 = require("../../ui/components/badge.js");
...
const ConnectWalletSocialOptions = (props) => {
    ...
    const lastUsedSocialAuth = (0, react_1.useMemo)(() => (0, storage_js_2.getLastUsedSocialAuth)(), []);
    const lastUsedWalletId = (0, react_1.useMemo)(() => (0, storage_js_2.getLastUsedWalletId)(), []);
    ...
    const _authOptions = (0, is_ecosystem_wallet_js_1.isEcosystemWallet)(wallet)
        ? (ecosystemAuthOptions ?? exports.defaultAuthOptions)
        : (wallet.getConfig()?.auth?.options ?? exports.defaultAuthOptions);
    const authOptions = (0, react_1.useMemo)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
                        ...
                        return ((0, jsx_runtime_1.jsxs)(SocialButton, { className: "tw-social-button", "aria-label": `Login with ${loginMethod}`, "data-variant": showOnlyIcons ? "icon" : "full", disabled: props.disabled, onClick: () => {
                                ...
                                position: "relative",
                            }, variant: "outline", children: [lastUsedWalletId === wallet.id &&
                                    lastUsedSocialAuth === loginMethod && (0, jsx_runtime_1.jsx)(badge_js_1.LastUsedBadge, {}), (0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: props.client, height: imgIconSize, src: walletIcon_js_1.socialIcons[loginMethod], width: imgIconSize }), !showOnlyIcons &&
                ...
                (inputMode === "email" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { className: "tw-input-container tw-input-container__email", lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "email", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "email", className: "tw-select-button tw-select-button__email", client: props.client, disabled: props.disabled, icon: EmailIcon_js_1.EmailIcon, onClick: () => {
                        setManualInputMode("email");
                    }, title: locale.emailPlaceholder }))), isPhoneEnabled &&
                (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(InputSelectionUI_js_1.InputSelectionUI, { className: "tw-input-container tw-input-container__phone", allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "phone", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (_input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "phone", className: "tw-select-button tw-select-button__phone", client: props.client, disabled: props.disabled, icon: PhoneIcon_js_1.PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder }))), passKeyEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "passkey", className: "tw-select-button tw-select-button__passkey", client: props.client, disabled: props.disabled, icon: FingerPrintIcon_js_1.FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey })), siweEnabled && !props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "wallet", className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "guest", className: "tw-select-button tw-select-button__guest", client: props.client, disabled: props.disabled, icon: GuestIcon_js_1.GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest })), props.isLinking && ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { lastUsedBadge: false, className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon_js_1.OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
