...
import { getLastUsedSocialAuth, getLastUsedWalletId, } from "../../ui/ConnectWallet/Modal/storage.js";
            ...
            position: "relative",
                        ...
                        return (_jsxs(SocialButton, { className: "tw-social-button", "aria-label": `Login with ${loginMethod}`, "data-variant": showOnlyIcons ? "icon" : "full", disabled: props.disabled, onClick: () => {
                                ...
                                position: "relative",
                                    ...
                                    lastUsedSocialAuth === loginMethod && _jsx(LastUsedBadge, {}), _jsx(Img, { client: props.client, height: imgIconSize, src: socialIcons[loginMethod], width: imgIconSize }), !showOnlyIcons &&
                ...
                (inputMode === "email" ? (_jsx(InputSelectionUI, { className: "tw-input-container tw-input-container__email", lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "email", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : (_jsx(WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "email", className: "tw-select-button tw-select-button__email", client: props.client, disabled: props.disabled, icon: EmailIcon, onClick: () => {
                ...
                (inputMode === "phone" ? (_jsx(InputSelectionUI, { className: "tw-input-container tw-input-container__phone", allowedSmsCountryCodes: wallet.getConfig()?.auth?.allowedSmsCountryCodes, defaultSmsCountryCode: wallet.getConfig()?.auth?.defaultSmsCountryCode, lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "phone", disabled: props.disabled, emptyErrorMessage: emptyErrorMessage, errorMessage: (_input) => {
                        ...
                        props.select();
                    }, placeholder: placeholder, submitButtonText: locale.submitEmail, type: type })) : (_jsx(WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "phone", className: "tw-select-button tw-select-button__phone", client: props.client, disabled: props.disabled, icon: PhoneIcon, onClick: () => {
                        setManualInputMode("phone");
                    }, title: locale.phonePlaceholder }))), passKeyEnabled && (_jsx(WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "passkey", className: "tw-select-button tw-select-button__passkey", client: props.client, disabled: props.disabled, icon: FingerPrintIcon, onClick: () => {
                    handlePassKeyLogin();
                }, title: locale.passkey })), siweEnabled && !props.isLinking && (_jsx(WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "wallet", className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
                }, title: locale.signInWithWallet })), guestEnabled && (_jsx(WalletTypeRowButton, { lastUsedBadge: lastUsedWalletId === wallet.id && lastUsedSocialAuth === "guest", className: "tw-select-button tw-select-button__guest", client: props.client, disabled: props.disabled, icon: GuestIcon, onClick: () => {
                    handleGuestLogin();
                }, title: locale.loginAsGuest })), props.isLinking && (_jsx(WalletTypeRowButton, { lastUsedBadge: false, className: "tw-select-button tw-select-button__link-wallet", client: props.client, icon: OutlineWalletIcon, onClick: () => {
                    handleWalletLogin();
