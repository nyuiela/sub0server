...
export declare const FN_SELECTOR: "0x5c60da1b";
/**
 ...
 * ```
 */
export declare function isImplementationSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function decodeImplementationResult(result: Hex): `0x${string}`;
/**
 ...
 * ```
 */
export declare function implementation(options: BaseTransactionOptions): Promise<string>;
