...
export const FN_SELECTOR = "0xed6ed279";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isGetTransferPoliciesForSignerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetTransferPoliciesForSignerParams(options) {
 ...
 * ```
 */
export function encodeGetTransferPoliciesForSigner(options) {
 ...
 * ```
 */
export function decodeGetTransferPoliciesForSignerResult(result) {
 ...
 * ```
 */
export async function getTransferPoliciesForSigner(options) {
    return readContract({
