...
export function SocialLogin(props) {
    ...
    return (_jsx(Container, { animate: "fadein", flex: "column", fullHeight: true, className: "tw-social-login-screen", children: _jsxs(Container, { expand: true, flex: "column", p: "lg", style: {
                paddingBottom: 0,
            }, children: [props.goBack && (_jsx(ModalHeader, { onBack: props.goBack, title: props.isLinking
                        ? props.connectLocale.manageWallet.linkProfile
                        : locale.title })), props.size === "compact" ? _jsx(Spacer, { y: "xl" }) : null, _jsxs(Container, { center: "both", expand: true, flex: "column", style: {
                        minHeight: "250px",
                        textAlign: "center",
                                        ...
                                        maxWidth: "250px",
                                    }, children: locale.instruction }), _jsx(Spacer, { y: "xl" }), _jsx(Container, { center: "x", flex: "row", children: _jsx(Spinner, { color: "accentText", size: "lg" }) }), _jsx(Spacer, { y: "xxl" })] })), status === "error" && (_jsxs(Container, { animate: "fadein", children: [authError ? (_jsx(Text, { center: true, color: "danger", children: authError })) : (_jsx(Text, { color: "danger", children: locale.failed })), _jsx(Spacer, { y: "lg" }), _jsx(Button, { onClick: handleSocialLogin, variant: "primary", children: locale.retry }), _jsx(Spacer, { y: "xxl" })] }))] })] }) }));
}
