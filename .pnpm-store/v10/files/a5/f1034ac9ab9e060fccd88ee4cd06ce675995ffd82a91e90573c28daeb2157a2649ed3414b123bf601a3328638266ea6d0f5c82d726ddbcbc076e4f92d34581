...
export declare class InAppWebConnector implements InAppConnector {
     ...
     * @internal
     */
    constructor({ client, onAuthSuccess, ecosystem, passkeyDomain, storage, }: InAppWalletConstructorType);
    initializeWallet(authToken?: string): Promise<IWebWallet>;
    /**
    ...
    loginWithAuthToken(authResult: AuthStoredTokenWithCookieReturnType, recoveryCode?: string): Promise<AuthLoginReturnType>;
    /**
    ...
    private passkeyAuth;
    linkProfileWithRedirect(strategy: SocialAuthOption, mode?: "redirect" | "window", redirectUrl?: string): Promise<void>;
