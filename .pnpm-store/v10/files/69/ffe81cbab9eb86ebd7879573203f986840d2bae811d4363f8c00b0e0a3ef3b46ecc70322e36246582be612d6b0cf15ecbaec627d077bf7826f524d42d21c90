...
const ConnectEmbedContent = (props) => {
    ...
    if (isAutoConnecting) {
        ...
        content = (_jsx(ConnectModalContent, { accountAbstraction: props.accountAbstraction, auth: props.auth, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, hideHeader: !props.header, isOpen: true, meta: {
                ...props.meta,
    ...
    return (_jsx(EmbedContainer, { className: props.className, modalSize: modalSize, style: props.style, children: modalSize === "wide" ? (content) : (_jsxs(DynamicHeight, { children: [" ", content, " "] })) }));
};
