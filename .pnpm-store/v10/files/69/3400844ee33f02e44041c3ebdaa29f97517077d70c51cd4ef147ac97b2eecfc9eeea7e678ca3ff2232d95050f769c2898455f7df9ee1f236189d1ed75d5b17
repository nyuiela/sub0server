 ...
 */
export declare function mint(options: BaseTransactionOptions<MintParams>): import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction, import("../../../transaction/prepare-transaction.js").PrepareTransactionOptions>;
export declare const encodeMintParams: typeof encodeBytesBeforeMintERC20Params;
export {};
