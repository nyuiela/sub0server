...
const Skeleton = (props) => {
    return ((0, jsx_runtime_1.jsx)(SkeletonDiv, { className: props.className || "", color: props.color, style: {
            height: props.height,
...
const skeletonAnimation = (0, react_1.keyframes) `
0% {
    opacity: 0.5;
  }
  100% {
...
`;
const SkeletonDiv = /* @__PURE__ */ (0, elements_js_1.StyledDiv)((props) => {
