...
export function DetailsModal(props) {
                    ...
                    paddingTop: spacing.lg,
                                ...
                                gap: spacing.xs,
                                        ...
                                        padding: spacing.sm,
                                                ...
                                                }, width: iconSize.sm }) }), locale.send] })), !hideReceiveFunds && (_jsxs(Button, { className: "tw-highlight-button__receive", onClick: () => {
                                        setScreen("receive");
                                    }, style: {
                                        alignItems: "center",
                                        display: "flex",
                                    ...
                                    !chainMetadataQuery.data.testnet && (_jsxs(Button, { className: "tw-highlight-button__buy", onClick: () => {
                                        trackPayEvent({
                                            client: client,
                            ...
                            gap: "1px",
                        }, children: [_jsx(NetworkSwitcherButton, { client: props.client, disableSwitchChain: disableSwitchChain, displayBalanceToken: props.displayBalanceToken, setScreen: () => setScreen("network-switcher"), showBalanceInFiat: props.detailsModal?.showBalanceInFiat }), _jsxs(MenuButton, { className: "tw-view-transactions-button", onClick: () => {
                                    setScreen("transactions");
                                }, style: {
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(TextAlignJustifyIcon, { height: iconSize.md, width: iconSize.md }), _jsx(Container, { center: "y", flex: "row", gap: "xs", children: _jsx(Text, { color: "primaryText", children: locale.transactions }) })] }), (props.assetTabs === undefined || props.assetTabs.length > 0) && (_jsxs(MenuButton, { className: "tw-view-assets-button", onClick: () => {
                                    setScreen("view-assets");
                                }, style: {
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(CoinsIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: locale.viewFunds.viewAssets })] })), _jsxs(MenuButton, { className: "tw-manage-wallet-button", onClick: () => {
    ...
    // thirdweb pay
        ...
        const requestedChainId = props.detailsModal?.payOptions?.prefillBuy?.chain?.id ||
            ...
            props.chains[0]?.id ||
            1;
        content = (_jsx(BuyWidget, { amount: props.detailsModal?.payOptions?.prefillBuy?.amount || "0.01", chain: getCachedChain(requestedChainId), client: client, hiddenWallets: props.detailsModal?.hiddenWallets, connectOptions: props.connectOptions, onCancel: () => setScreen("main"), onSuccess: () => setScreen("main"), supportedTokens: props.supportedTokens, theme: props.theme, style: {
                border: "none",
                borderRadius: radius.lg,
            }, tokenAddress: props.displayBalanceToken?.[Number(requestedChainId)] }));
    }
    return (_jsx(CustomThemeProvider, { theme: props.theme, children: _jsx(WalletUIStatesProvider, { isOpen: false, theme: props.theme, children: _jsx(ScreenSetupContext.Provider, { value: screenSetup, children: _jsx(Modal, { className: "tw-modal__wallet-details", title: "Manage Wallet", open: isOpen, crossContainerStyles: {
...
export function NetworkSwitcherButton(props) {
    ...
    return (_jsxs(MenuButton, { className: "tw-internal-network-switcher-button tw-switch-network-button", "data-variant": "primary", disabled: disableSwitchChain, onClick: () => {
