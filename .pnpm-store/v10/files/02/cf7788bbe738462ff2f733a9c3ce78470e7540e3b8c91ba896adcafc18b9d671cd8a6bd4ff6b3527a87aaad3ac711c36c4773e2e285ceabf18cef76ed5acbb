 ...
 * ```
 */
export declare function setClaimCondition(options: BaseTransactionOptions<ClaimConditionInput>): import("../../../transaction/prepare-transaction.js").PreparedTransaction<any, import("abitype").AbiFunction, import("../../../transaction/prepare-transaction.js").PrepareTransactionOptions>;
