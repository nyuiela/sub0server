...
declare const supportedX402Versions: readonly [1, 2];
export type X402Version = (typeof supportedX402Versions)[number];
export declare const x402Version: X402Version;
/**
 ...
 */
export type PaymentRequiredResult = PaymentRequiredResultV1 | PaymentRequiredResultV2;
/**
