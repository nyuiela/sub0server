...
import { CheckoutWidget, } from "../../react/web/ui/Bridge/CheckoutWidget.js";
...
export const DigitalArt = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.digitalArt.paymentInfo.token.chainId),
...
export const DigitalArtJPCurrency = {
    args: {
        amount: DIRECT_PAYMENT_UI_OPTIONS.digitalArt.paymentInfo.amount,
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.digitalArt.paymentInfo.token.chainId),
        currency: "JPY",
...
export const ConcertTicket = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.concertTicket.paymentInfo.token.chainId),
...
export const SubscriptionService = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.subscription.paymentInfo.token.chainId),
...
export const PhysicalProduct = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.sneakers.paymentInfo.token.chainId),
...
export const NoImage = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.credits.paymentInfo.token.chainId),
...
export const CustomButtonLabel = {
    args: {
        ...
        chain: defineChain(DIRECT_PAYMENT_UI_OPTIONS.customButton.paymentInfo.token.chainId),
...
function StoryVariant(props) {
    return (_jsxs("div", { style: {
            ...
            gap: "40px",
            alignItems: "center",
        }, children: [_jsx(CheckoutWidget, { ...props, theme: "dark" }), _jsx(CheckoutWidget, { ...props, theme: "light" })] }));
}
