...
async function settlePayment(args) {
    ...
    try {
        const paymentResponseHeaderName = (0, headers_js_1.getPaymentResponseHeader)(decodedPayment.x402Version);
        ...
        if (settlement.success) {
            return {
                ...
                responseHeaders: {
                    ...
                    [paymentResponseHeaderName]: (0, encode_js_1.safeBase64Encode)((0, json_js_1.stringify)(settlement)),
                },
            };
        }
        else {
            ...
            return {
                ...
                responseBody: {
                    x402Version: decodedPayment.x402Version ?? types_js_1.x402Version,
                    error,
