...
export declare const FN_SELECTOR: "0xa65d69d4";
/**
 ...
 * ```
 */
export declare function isEntrypointSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function decodeEntrypointResult(result: Hex): `0x${string}`;
/**
