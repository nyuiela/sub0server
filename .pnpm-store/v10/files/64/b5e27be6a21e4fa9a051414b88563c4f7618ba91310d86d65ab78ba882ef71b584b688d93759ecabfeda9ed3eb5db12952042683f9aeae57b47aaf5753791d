 ...
 * @beta
 */
export declare function tokens<IncludePrices extends boolean = true, R extends Token | TokenWithPrices = TokenWithPrices>(options: tokens.Options<IncludePrices>): Promise<R[]>;
