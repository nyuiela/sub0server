...
export declare const socialAuthOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "tiktok", "epic", "coinbase", "farcaster", "telegram", "github", "twitch", "steam"];
export type SocialAuthOption = (typeof socialAuthOptions)[number];
export type OAuthOption = SocialAuthOption | "guest";
export declare const authOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "tiktok", "epic", "coinbase", "farcaster", "telegram", "github", "twitch", "steam", "guest", "backend", "email", "phone", "passkey", "wallet"];
