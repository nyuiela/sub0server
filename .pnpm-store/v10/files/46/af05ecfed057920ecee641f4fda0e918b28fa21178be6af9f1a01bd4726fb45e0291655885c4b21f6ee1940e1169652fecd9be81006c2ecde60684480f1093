...
exports.handleSmartWalletConnection = exports.LAST_USED_WALLET_ID = void 0;
...
exports.LAST_USED_WALLET_ID = "thirdweb:last-used-wallet-id";
/**
...
function createConnectionManager(storage) {
    ...
    const handleConnection = async (wallet, options) => {
        ...
        await storage.setItem(exports.LAST_USED_WALLET_ID, wallet.id);
    ...
    const setActiveWallet = async (activeWallet) => {
        ...
        if (activeWallet.id !== "smart") {
            ...
            await storage.setItem(exports.LAST_USED_WALLET_ID, activeWallet.id);
        }
    };
    // side effects
    (0, effect_js_1.effect)(() => {
