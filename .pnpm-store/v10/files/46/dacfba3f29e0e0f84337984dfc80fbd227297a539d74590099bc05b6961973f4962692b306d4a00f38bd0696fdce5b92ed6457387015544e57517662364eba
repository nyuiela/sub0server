    ...
    const connect = (0, react_1.useCallback)((props) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            (0, getConnectLocale_js_1.getConnectLocale)(props.locale || "en_US")
                .then((locale) => {
                setRootEl((0, jsx_runtime_1.jsx)(Modal, { ...props, connectLocale: locale, onClose: () => {
                        reject();
                        cleanup();
                    }, onConnect: (w) => {
                        if (props.auth)
...
function Modal(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { isOpen: true, theme: props.theme, children: (0, jsx_runtime_1.jsx)(ConnectModal_js_1.default, { accountAbstraction: props.accountAbstraction, auth: props.auth, chain: props.chain, chains: props.chains, client: props.client, connectLocale: props.connectLocale, hiddenWallets: props.hiddenWallets, localeId: props.locale || "en_US", meta: meta, onClose: props.onClose, onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, shouldSetActive: props.setActive === undefined ? true : props.setActive, showAllWallets: props.showAllWallets, size: size, walletConnect: props.walletConnect, wallets: wallets, welcomeScreen: props.welcomeScreen }) }));
}
