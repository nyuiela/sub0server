...
export async function createStylusProject() {
    ...
    if (projectType === "default") {
        ...
        const repoUrl = "git@github.com:thirdweb-example/stylus-transferable-erc20.git";
        ...
        const repoUrl = "git@github.com:thirdweb-example/stylus-mintable-erc721.git";
        ...
        const repoUrl = "git@github.com:thirdweb-example/stylus-transferable-erc721.git";
        ...
        const repoUrl = "git@github.com:thirdweb-example/stylus-mintable-erc1155.git";
        ...
        const repoUrl = "git@github.com:thirdweb-example/stylus-transferable-erc1155.git";
        spinner.start(`Creating new ERC1155 Transferable module: ${projectName}...`);
        newProject = spawnSync("git", ["clone", repoUrl, projectName], {
            stdio: "inherit",
        });
    }
