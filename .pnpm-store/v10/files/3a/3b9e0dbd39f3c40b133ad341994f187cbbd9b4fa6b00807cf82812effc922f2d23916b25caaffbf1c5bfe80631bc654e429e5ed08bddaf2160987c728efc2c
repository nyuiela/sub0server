 ...
 * @example
 * ```ts
 * import { encodeVerifyParams } from "thirdweb/extensions/erc20";
 ...
 * @example
 * ```ts
 * import { encodeVerify } from "thirdweb/extensions/erc20";
 ...
 * ```
 */
export declare function decodeVerifyResult(result: Hex): readonly [boolean, `0x${string}`];
/**
