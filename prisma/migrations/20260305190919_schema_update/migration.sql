...
CREATE TABLE "PendingAgentTrade" (
    ...
    "tradeReason" TEXT NOT NULL,
    "side" "OrderSide" NOT NULL,
    "status" "PendingAgentTradeStatus" NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE "Market" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "liquiditySeeded" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "UserBalance_tokenAddress_idx" ON "UserBalance"("tokenAddress");
